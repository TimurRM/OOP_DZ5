...
public class BookingView implements View {
    ...
    public void changeReservationTable(int oldReservation, Date newDate, int newTableNo, String newName) {
        for (ViewObserver observer : observers) {
            observer.onChangeReservation(oldReservation, newDate, newTableNo, newName);
        }
    }
}
